            ...
            <div class="px-6 py-4">
                ...
                <form wire:submit.prevent='updateQuestion' class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900">Variable</label>
                    ...
                    <div class="flex justify-end mb-2 mt-6">
                        ...
                        <button type="submit"
                            class="button-darkblue text-white font-bold py-2 px-6 rounded">Simpan</button>
                    </div>
                </form>
            </div>
            <hr>
